...
public class EditServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        contact.updateContacto(con);
        }
        
        response(con, resp, error);

    }

    private void response(Contacto con, HttpServletResponse resp, Boolean error) throws IOException {
        ControllerContacto controller = new ControllerContacto();
        ...
        out.println("<div class=\"container\">\n" + menu + ""
                ...
                + "        <br>");
        if(error == true){
            out.println("<h1> Eerror al crear el usuario </h1>");
        }else{
        out.println("<h1> Contacto con id: " + con.getNombre() + " editado.</h1>");
        }
        out.println("</body>");
        out.println("</html>");
    }
